...
for mmax in (3, 120):
    ...
    ChabrierPMF_IS.normalize(mmin=mmin, mmax=mmax)
    ChabrierPMF_TC.normalize(mmin=mmin, mmax=mmax)
    ChabrierPMF_CA.normalize(mmin=mmin, mmax=mmax)
    ...
    KroupaPMF_IS.normalize(mmin=mmin, mmax=mmax)
    KroupaPMF_TC.normalize(mmin=mmin, mmax=mmax)
    KroupaPMF_CA.normalize(mmin=mmin, mmax=mmax)
    #KroupaPMF_2CTC.normalize(log=True, mmin=mmin, mmax=mmax)

    chabrier2005 = imf.chabrier2005
    chabrier2005.normalize(mmin=mmin, mmax=mmax)
    kroupa = imf.Kroupa()
    kroupa.normalize(mmin=mmin, mmax=mmax)
    ...
    for mass_weighted in (True,False):
        ...
        ax.loglog(masses, ChabrierPMF_CA.__getattribute__(fname)(masses), label="CA", color='orange', linestyle=(0,(5,2,1,2,1,2,1,2)))
        ...
        pl.legend(loc='best')
        pl.savefig('plots/steadystate_pmf_chabrier{0}_mmax{1}.pdf'.format("_integral" if mass_weighted else "",
        ...
        fig2.clf()
        ax = fig2.gca()
        ax.set_title("Tapered McKee/Offner + Chabrier PMF",y=1.03)
        ax.loglog(masses, chabrier2005.__getattribute__(fname)(masses), label="IMF", color='k')
        ...
        ax.loglog(masses, ChabrierPMF_CA.__getattribute__(fname)(masses, taper=True), label="CA", color='orange', linestyle=(0,(5,2,1,2,1,2,1,2)))
        ...
        pl.legend(loc='best')
        pl.savefig('plots/taperedaccretion_pmf_chabrier{0}_mmax{1}.pdf'.format("_integral" if mass_weighted else "",
                                                                               int(mmax)), bbox_inches='tight')
        ...
        ax3.loglog(masses, KroupaPMF_CA.__getattribute__(fname)(masses), label="CA", color='orange', linestyle=(0,(5,2,1,2,1,2,1,2)))
        ...
        pl.legend(loc='best')
        pl.savefig('plots/steadystate_pmf_kroupa{0}_mmax{1}.pdf'.format("_integral" if mass_weighted else "",
                                                                        int(mmax)), bbox_inches='tight')
        ...
        ax4.loglog(masses, KroupaPMF_CA.__getattribute__(fname)(masses, taper=True), label="CA", color='orange', linestyle=(0,(5,2,1,2,1,2,1,2)))
        ...
        pl.legend(loc='best')
        pl.savefig('plots/taperedaccretion_pmf_kroupa{0}_mmax{1}.pdf'.format("_integral" if mass_weighted else "",
                                                                             int(mmax)), bbox_inches='tight')
